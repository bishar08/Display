...
while True:
  if selected2 == "Agents":
    ...
    with placeholder.container():
      ...
      osman_data.write('<h3>Hon. ABDIKARIM</h3>',unsafe_allow_html=True)
      major_data.write('<h3>Hon. DEKOW</h3>',unsafe_allow_html=True)
      jofle_data.write('<h3>Hon. NASSIR</h3>',unsafe_allow_html=True)
      ...
      feisal_data.write('<h3>Hon. FEISAL</h3>',unsafe_allow_html=True)
      muhiadin_data.write('<h3>Hon. MUHIADIN</h3>',unsafe_allow_html=True)
    ...
    with placeholder.container():
      ...
      for file in os.listdir(datadir):
        ...
        print(f)
        st.image("images/"+file,width=220,caption=file)
